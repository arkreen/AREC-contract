...
import { IWETH9, MockTimeNonfungiblePositionManager, MockTimeSwapRouter, TestERC20Uni } from '../../typechain'
...
describe('SwapRouter', function () {
  ...
  let tokens: [TestERC20Uni, TestERC20Uni, TestERC20Uni]
  let getBalances: (
    who: string
  ) => Promise<{
    weth9: BigNumber
...
//        params.amountOutMinimum -= 1
      ...
      describe('single-pool', () => {
        it('0 -> 1', async () => {
          ...
          console.log('AAAAAAAAA',  traderBefore.token0.toString(), traderAfter.token0.toString(),
                                    traderAfter.token1.toString(), traderAfter.token1.toString(),
                                    poolAfter.token0.toString(), poolAfter.token0.toString(),
                                    poolAfter.token1.toString(), poolAfter.token1.toString())
