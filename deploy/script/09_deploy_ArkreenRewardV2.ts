...
const func: DeployFunction = async (hre: HardhatRuntimeEnvironment) => {
    ...
    const arkRewardV2 = "ArkreenRewardUpgradeableV2"
    ...
    console.log("Deploying: ", arkRewardV2, deployer);  
    const ArkreenReward = await deploy(arkRewardV2, {
        from: deployer,
        proxy: {
