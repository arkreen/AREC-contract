...
//  await updateTx.wait()
    ...
    const levelOrder = [ 0x0101, 0x0102, 0x0103, 0x0104, 0x0201, 0x0202, 0x0105, 0x0203, 0x0204,
                         ...
                         0x0112, 0x0113 ]
    const newLevelOrder = levelOrder.map((level)=>(level-0x0101))

    const callData = HashKeyESGBTCFactory.interface.encodeFunctionData("postUpdate", [newLevelOrder])  //levelOrder
